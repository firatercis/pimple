...
namespace SoftwareKingdom.Ads.Admob
{
 
    public class AdmobController : MonoBehaviour, IAdManager // TODO: Just for Rewarded Interstitial for now.
    {
        /// <summary>
     ...
     //   private const string _adUnitId = "ca-app-pub-3940256099942544/5354046379";
        ...
        public void LoadAd(string adId)
        {
            ...
            RewardedInterstitialAd.Load(adId, adRequest,
